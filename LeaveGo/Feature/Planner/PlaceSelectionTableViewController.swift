        ...
        do {
            if let fetchedList = try await NetworkManager.shared.FetchAreaBasedPlaceList(area: area) {
                ...
                self.placeList = fetchedList.map {
                    PlaceModel(add1: $0.addr1, add2: $0.addr2, contentId: $0.contentId, title: $0.title, bigThumbnailURL: $0.thumbnailImage, thumbnailURL: $0.thumbnailImage, distance: nil, latitude: $0.mapY, longitude: $0.mapX, areaCode: $0.areaCode, cat1: $0.cat1, cat2: $0.cat2, cat3: $0.cat3)
                }
