...
//        window?.makeKeyAndVisible()
        ...
        guard let windowScene = (scene as? UIWindowScene) else { return }
               ...
               let targetSB = UIStoryboard(name: "AddNewTrip", bundle: nil)
               
                // 앱 실행시 먼저 보이는 스토리보드 뷰 - 임시로 설정한 작업 화면
                    if let targetVC = targetSB.instantiateViewController(withIdentifier: "AddNewTripVC") as? AddNewTripViewController {
